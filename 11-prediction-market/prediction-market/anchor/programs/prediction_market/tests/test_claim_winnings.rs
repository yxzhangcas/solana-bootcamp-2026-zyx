...
use crate::prediction_market::accounts::UserPosition;
...
pub fn test_claim_winnings() {
    ...
    let ix = ctx
        .program()
        .accounts(prediction_market::client::accounts::ClaimWinnings {
            user: user.pubkey(),
            market: market_pda,
            user_position: user_pda,
            system_program: system_program::ID,
        })
        .args(prediction_market::client::args::ClaimWinnings {})
        .instruction()
        .unwrap();
